...
for (var i = 0; i < 10; i++) {
    setTimeout(() => { console.log("setTimeout(() => { console.log(`i`, i); }, 1000);", i); }, 1000);
}

for (var i = 0; i < 10; i++) {
    setTimeout(function (i) // добавил аргумент i чтобы изменить скоуп и скрыть i  из цикла
        {console.log(i);}(i) // ---  добавил  ( i ) чтобы сразу вызвать функцию анонимную и сделать
        , 2220);
}

for (var i = 0; i < 10; i++) {
    setTimeout(function ( k ) {console.log( k );}( i ), 2220);
}
